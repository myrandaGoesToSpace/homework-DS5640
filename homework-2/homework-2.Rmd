...
legend("topleft", c("L1", "Tilted, tau = 0.25", "Tilted, tau = 0.75"), lwd = c(2,2,2),col = c("darkgreen", "pink", "yellow"))
...
nonlin_pred_l1 <- predict_nonlin(x=x_grid, beta=lin_beta_l1$par)
...
nonlin_beta_tilt_25 <- fit_nonlin_tilt(y = prostate_train$lcavol,
                         ...
                         tau = 0.25,
                         loss = tilted_loss)
nonlin_pred_tilt_25 <- predict_nonlin(x = x_grid, beta = lin_beta_tilt_25$par)
...
nonlin_pred_tilt_75 <- predict_nonlin(x = x_grid, beta = lin_beta_tilt_75$par)
